  ...
  return (
    <section className="bg-bocra-navy/[0.97] relative overflow-hidden">
      ...
      <div className="max-w-[980px] mx-auto px-4 md:px-5 py-12 md:py-14 relative z-10">
        ...
        <p className="text-sm text-white/40 mt-1.5 mb-7 max-w-[480px]">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
          {sectors.map((s) => (
            <div
              key={s.label}
              className="bg-white/[0.06] backdrop-blur-sm rounded-xl p-5 border border-white/[0.06] text-center transition-all hover:bg-white/[0.1] hover:border-white/[0.1]"
            >
              <div
