...
export default function Hero() {
  ...
  return (
    <section className="relative z-20 bg-bocra-navy">
      ...
      <div className="relative z-10 max-w-[980px] mx-auto px-4 md:px-5 pt-12 md:pt-16 pb-14 md:pb-20">
        ...
        <div ref={wrapperRef} className="max-w-[520px] mx-auto relative z-30 mb-8 animate-fade-up animate-delay-2">
          ...
          {dropdownOpen && (
            <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-xl shadow-[0_20px_60px_rgba(0,0,0,0.35)] border border-gray-100 overflow-hidden z-50 animate-slide-up">
              {query.trim().length > 0 ? (
