    ...
    <>
      <section className="relative overflow-hidden bg-gradient-to-br from-bocra-magenta to-[#B8155A] py-9 px-4">
        <div className="max-w-[980px] mx-auto relative">
          <div className="text-xs text-white/45 mb-2"><a href="/" className="underline hover:text-white/70 transition-colors">Home</a>{" / "}<a href="/complaints" className="underline hover:text-white/70 transition-colors">Complaints</a>{" / Track"}</div>
      ...
      <div className="max-w-[700px] mx-auto px-4 md:px-5 py-7"><ComplaintTracker id={params.id} /></div>
    </>
  );
}
